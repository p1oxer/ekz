...
document.querySelector("main").style.paddingTop = headerHeight - 1 + "px";
...
let modalContentPlaceholder = modal.querySelector(".body-modal__content");
...
openModalButton.forEach((i) => {
    i.addEventListener("click", () => {
        ...
        document.querySelector(".body-modal__name").textContent = modalTitle;
...
const openModalRegister = document.querySelectorAll(".body-events-tabs__button");
